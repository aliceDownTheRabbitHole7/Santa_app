    ...
    <div className='flex flex-wrap justify-center mb-5'>
        ...
        <div className="bio mt-5 rounded-2xl">
          <div className='flex flex-col justify-center'>
            <h1 className='bio-title text-center pt-5 text-red-800'>Santa Claus</h1>
            <div className="bio-paragraph px-8 pt-4">
              <p>I call the North Pole my home, and it's where my trusted team of cheerful elves and I work tirelessly throughout the year, crafting toys and gifts for children everywhere. It's a busy place, but the joy of bringing smiles to kids' faces makes it all worth it.</p>
              <br></br>
              <p>On the magical night of December 24th, I set out on my incredible journey in a sleigh pulled by my dear reindeer, with Rudolph leading the way. With my bottomless sack of gifts, I visit homes all over the world, sneaking down chimneys or finding other creative ways to leave presents under the Christmas tree.</p>
              <br></br>
